...
public class QuoteController{
    ...
    //@ApiOperation(value = "Update quote table ung iex data", notes = "Update all quotes in the quote table. Use IEX trading API as market data source.")
    ...
    //@ApiOperation(value = "Add a new ticker to the dailyList (qe table)",
